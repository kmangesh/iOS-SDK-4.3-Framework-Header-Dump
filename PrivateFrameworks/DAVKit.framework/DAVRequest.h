...
@class NSMutableSet, NSDictionary, NSData, NSDate, NSMutableData, NSString, DAVSession, NSMutableDictionary;
...
+(void)setLogRequestSynopsis:(BOOL)synopsis;
+(BOOL)logHTTPActivity;
+(void)setLogHTTPActivity:(BOOL)activity;
...
-(id)_nonceFromAuthHeader:(id)authHeader;
-(BOOL)_nonceIsStale:(id)stale;
