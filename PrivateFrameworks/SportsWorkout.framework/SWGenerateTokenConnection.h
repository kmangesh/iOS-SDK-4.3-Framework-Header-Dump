...
@class NSString;
@protocol SWSyncServiceConnectionDelegate, SWGenerateTokenConnectionDelegate;
...
@property(assign, nonatomic) id<SWSyncServiceConnectionDelegate, SWGenerateTokenConnectionDelegate> delegate;
