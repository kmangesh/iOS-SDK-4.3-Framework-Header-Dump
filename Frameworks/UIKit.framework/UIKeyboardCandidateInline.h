...
@class NSArray, NSTimer, UIScroller, UIKeyboardGenericKeyView, UIKeyboardCandidateSafetyNetVie, UIImage, NSMutableArray, UIAutocorrectInlinePrompt, NSString, UILabel, UIImageView;
...
-(BOOL)_layoutNextLineWithMarginLeft:(float)marginLeft marginRight:(float)right candidateFrameWidth:(float)width;
