...
@class NSString, MPMovieSnapshotController, UIMovieSubtitlesView, MPVideoBufferLayerContainer, UIView, CALayer;
...
@property(assign, nonatomic) float subtitlesFontSize;
